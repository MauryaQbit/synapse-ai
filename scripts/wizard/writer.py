...
def _default_tools() -> list[dict[str, Any]]:
    return [
        {"name": "image_search", "use": "SynapseAI.community.image_search.tools:image_search_tool", "group": "web", "max_results": 5},
        {"name": "ls", "use": "SynapseAI.sandbox.tools:ls_tool", "group": "file:read"},
        {"name": "read_file", "use": "SynapseAI.sandbox.tools:read_file_tool", "group": "file:read"},
        {"name": "glob", "use": "SynapseAI.sandbox.tools:glob_tool", "group": "file:read"},
        {"name": "grep", "use": "SynapseAI.sandbox.tools:grep_tool", "group": "file:read"},
        {"name": "write_file", "use": "SynapseAI.sandbox.tools:write_file_tool", "group": "file:write"},
        {"name": "str_replace", "use": "SynapseAI.sandbox.tools:str_replace_tool", "group": "file:write"},
        {"name": "bash", "use": "SynapseAI.sandbox.tools:bash_tool", "group": "bash"},
    ]
...
def _build_tools(
    *,
    ...
    if include_bash_tool:
        tools.append({"name": "bash", "use": "SynapseAI.sandbox.tools:bash_tool", "group": "bash"})
...
def build_minimal_config(
    *,
    ...
    sandbox_use: str = "SynapseAI.sandbox.local:LocalSandboxProvider",
    ...
    if sandbox_use == "SynapseAI.sandbox.local:LocalSandboxProvider":
