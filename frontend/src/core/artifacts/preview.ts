...
export const HTML_PREVIEW_SCROLL_MESSAGE_SOURCE =
  "SynapseAI-artifact-preview-scroll";
...
function htmlScrollRestorationScript(messageKey: string) {
  return `<script data-SynapseAI-artifact-scroll-restoration>
(() => {
...
export function appendHtmlPreviewScrollRestoration(
  ...
  if (content.includes("data-SynapseAI-artifact-scroll-restoration")) {
    return content;
  }
