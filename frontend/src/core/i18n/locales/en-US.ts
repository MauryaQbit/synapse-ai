...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 SynapseAI, an open source super agent. With built-in and custom skills, SynapseAI helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of SynapseAI. With customized skills,\nSynapseAI can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  inputBox: {
    ...
    disclaimer: "SynapseAI is AI and can make mistakes",
    createSkillPrompt:
    ...
    voiceInputStart:
      "Dictate with voice. SynapseAI receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. SynapseAI is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but SynapseAI could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "SynapseAI's official website",
    githubTooltip: "SynapseAI on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "SynapseAI on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About SynapseAI",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      buzz: "Buzz channels and direct messages through your SynapseAI agent.",
      telegram: "Telegram direct messages through your SynapseAI bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your SynapseAI bot.",
      feishu: "Feishu and Lark messages through your SynapseAI app.",
      dingtalk: "DingTalk Stream Push messages through your SynapseAI bot.",
      wechat: "WeChat iLink messages through your SynapseAI bot.",
      wecom: "WeCom messages through your SynapseAI AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to SynapseAI",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate SynapseAI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how SynapseAI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "SynapseAI automatically learns from your conversations in the background. These memories help SynapseAI understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to SynapseAI from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "Point your SynapseAI account at a different Lark/Feishu app. This only affects your account; other users are not changed.",
        ...
        authStarted:
          "Authorization page opened. SynapseAI will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; SynapseAI keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, SynapseAI only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. SynapseAI keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. SynapseAI will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; SynapseAI checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      title: "Agent Skills",
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of SynapseAI.",
    ...
    notification: {
      title: "Notification",
      description:
        "SynapseAI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so SynapseAI cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. SynapseAI stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "SynapseAI needs an administrator account before new regular accounts can be created.",
