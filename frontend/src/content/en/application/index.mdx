---
title: SynapseAI App
description: SynapseAI App is the reference implementation of what a production SynapseAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  SynapseAI App is a complete Super Agent application built on top of SynapseAI
...
SynapseAI App is the reference implementation of what a production SynapseAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The SynapseAI App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, SynapseAI Harness                               |
| Reverse proxy     | nginx                                                                |
