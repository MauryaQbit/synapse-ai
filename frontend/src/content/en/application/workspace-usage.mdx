...
description: The SynapseAI App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.
---
...
The SynapseAI App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.
...
If token usage display is enabled, SynapseAI shows one conversation-level total in
