...
description: This tutorial guides you through deploying SynapseAI to a production environment using Docker Compose for multi-user access.
---
...
This tutorial guides you through deploying SynapseAI to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.synapse-ai/` directory regularly
