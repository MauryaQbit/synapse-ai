...
[对应的实现提交](https://github.com/bytedance/synapse-ai/commit/be0eae9825619b63ca0c67b253d40b5eee76a2d6) 处理的就是这个边界：当 provider 用安全信号中止生成，同时响应仍带有工具调用时，SynapseAI 应先压制这些工具调用，再把这一轮作为安全中止事件记录下来。
