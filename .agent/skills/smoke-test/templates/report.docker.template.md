...
|----------|------|----------|
| synapse-ai-nginx | {{nginx_status}} | {{nginx_uptime}} |
| synapse-ai-frontend | {{frontend_status}} | {{frontend_uptime}} |
| synapse-ai-gateway | {{gateway_status}} | {{gateway_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using SynapseAI
