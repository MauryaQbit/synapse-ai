...
### 2. `backend/packages/harness/SynapseAI/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/SynapseAI/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_SynapseAI_20260201.md`
