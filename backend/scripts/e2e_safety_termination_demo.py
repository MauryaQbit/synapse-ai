"""End-to-end demo: SafetyFinishReasonMiddleware on the real SynapseAI lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``SynapseAIClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from SynapseAI.models import create_chat_model``,
    ...
    # imported names.
    import SynapseAI.agents.lead_agent.agent as lead_agent_module
    import SynapseAI.client as client_module
