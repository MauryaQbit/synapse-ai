...
Requirements:
    ...
    resolves SynapseAI-harness and app packages correctly:
...
async def main():
    ...
    from SynapseAI.config.app_config import apply_logging_level

    app_config = get_app_config()
    apply_logging_level(app_config.log_level)

    # Delay the rest of the SynapseAI imports until *after* logging is installed
    # so that any import-time side effects (e.g. SynapseAI.agents starts a
    ...
    from SynapseAI.mcp import initialize_mcp_tools
