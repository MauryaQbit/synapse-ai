"""Tests for SynapseAI.runtime.serialization."""
...
def test_serialize_none():
    from SynapseAI.runtime.serialization import serialize_lc_object
...
def test_serialize_messages_tuple():
    from SynapseAI.runtime.serialization import serialize_messages_tuple
...
def test_strip_data_url_removes_base64_from_hidden_messages():
    from SynapseAI.runtime.serialization import strip_data_url_image_blocks
...
def test_serialize_channel_values_for_api_strips_base64():
    from SynapseAI.runtime.serialization import serialize_channel_values_for_api
