...
class TestWebSearchTool:
    ...
    @patch("SynapseAI.community.fastcrw.tools.FirecrawlApp")
    @patch("SynapseAI.community.fastcrw.tools.get_app_config")
    def test_search_uses_web_search_config(self, mock_get_app_config, mock_fastcrw_cls):
        ...
        from SynapseAI.community.fastcrw.tools import web_search_tool
...
class TestWebFetchTool:
    ...
    def test_fetch_uses_web_fetch_config(self, mock_get_app_config, mock_fastcrw_cls):
        ...
        from SynapseAI.community.fastcrw.tools import web_fetch_tool
