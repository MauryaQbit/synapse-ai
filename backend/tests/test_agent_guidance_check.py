...
EXPECTED_GUIDANCE_PATHS = {
    ...
    "backend/packages/harness/SynapseAI/AGENTS.md",
    "backend/packages/harness/SynapseAI/agents/AGENTS.md",
    "backend/packages/harness/SynapseAI/agents/middlewares/AGENTS.md",
    "backend/packages/harness/SynapseAI/agents/memory/AGENTS.md",
    "backend/packages/harness/SynapseAI/config/AGENTS.md",
    "backend/packages/harness/SynapseAI/extensions/AGENTS.md",
    "backend/packages/harness/SynapseAI/runtime/AGENTS.md",
    "backend/packages/harness/SynapseAI/sandbox/AGENTS.md",
    "backend/packages/harness/SynapseAI/mcp/AGENTS.md",
    "backend/packages/harness/SynapseAI/models/AGENTS.md",
    "backend/packages/harness/SynapseAI/persistence/migrations/AGENTS.md",
    "backend/packages/harness/SynapseAI/reflection/AGENTS.md",
    "backend/packages/harness/SynapseAI/skills/AGENTS.md",
    "backend/packages/harness/SynapseAI/subagents/AGENTS.md",
    "backend/packages/harness/SynapseAI/tools/AGENTS.md",
    "backend/packages/harness/SynapseAI/tracing/AGENTS.md",
    "backend/packages/harness/SynapseAI/tui/AGENTS.md",
...
def _load_checker():
    ...
    spec = importlib.util.spec_from_file_location("SynapseAI_agent_guidance_check", CHECKER_PATH)
...
def test_local_guidance_files_contain_the_split_original_sections() -> None:
    expected_headings = {
        ...
        "backend/packages/harness/SynapseAI/agents/AGENTS.md": "### Agent System",
        "backend/packages/harness/SynapseAI/agents/middlewares/AGENTS.md": "### Middleware Chain",
        "backend/packages/harness/SynapseAI/agents/memory/AGENTS.md": "### Memory System",
        "backend/packages/harness/SynapseAI/config/AGENTS.md": "### Configuration System",
        "backend/packages/harness/SynapseAI/extensions/AGENTS.md": "### Python Extension System",
        "backend/packages/harness/SynapseAI/runtime/AGENTS.md": "### Checkpoint Channel Modes",
        "backend/packages/harness/SynapseAI/sandbox/AGENTS.md": "### Sandbox System",
        "backend/packages/harness/SynapseAI/mcp/AGENTS.md": "### MCP System",
        "backend/packages/harness/SynapseAI/models/AGENTS.md": "### Model Factory",
        "backend/packages/harness/SynapseAI/persistence/migrations/AGENTS.md": "### Schema Migrations",
        "backend/packages/harness/SynapseAI/reflection/AGENTS.md": "### Reflection System",
        "backend/packages/harness/SynapseAI/skills/AGENTS.md": "### Skills System",
        "backend/packages/harness/SynapseAI/subagents/AGENTS.md": "### Subagent System",
        "backend/packages/harness/SynapseAI/tools/AGENTS.md": "### Tool System",
        "backend/packages/harness/SynapseAI/tracing/AGENTS.md": "### Tracing System",
        "backend/packages/harness/SynapseAI/tui/AGENTS.md": "### Terminal Workbench / TUI",
