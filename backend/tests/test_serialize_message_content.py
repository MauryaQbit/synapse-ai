...
See: https://github.com/MauryaQbit/synapse-ai/issues/1149
"""
...
class TestSerializeToolMessageContent:
    """SynapseAIClient._serialize_message should normalize ToolMessage content."""
...
class TestExtractText:
    """SynapseAIClient._extract_text should handle all content shapes."""

    def test_string_passthrough(self):
        assert SynapseAIClient._extract_text("hello") == "hello"

    def test_list_text_blocks(self):
        assert SynapseAIClient._extract_text([{"type": "text", "text": "hi"}]) == "hi"

    def test_empty_list(self):
        assert SynapseAIClient._extract_text([]) == ""

    def test_fallback_non_iterable(self):
        assert SynapseAIClient._extract_text(123) == "123"
