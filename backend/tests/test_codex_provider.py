"""Tests for SynapseAI.models.openai_codex_provider.CodexChatModel.
...
from SynapseAI.models.credential_loader import CodexCliCredential
...
def _make_model(**kwargs):
    ...
    with patch("SynapseAI.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
