...
from SynapseAI.agents.memory.backends.deermem.deermem.core.prompt import (
    _count_tokens,
...
class TestGetTiktokenEncoding:
    ...
    def test_returns_none_when_tiktoken_unavailable(self, monkeypatch):
        monkeypatch.setattr("SynapseAI.agents.memory.backends.deermem.deermem.core.prompt.TIKTOKEN_AVAILABLE", False)
    ...
    def test_returns_encoding_on_success(self, monkeypatch):
        ...
        fake_enc = mock.Mock()
        monkeypatch.setattr("SynapseAI.agents.memory.backends.deermem.deermem.core.prompt.tiktoken.get_encoding", mock.Mock(return_value=fake_enc))
    ...
    def test_failure_self_heals_after_cooldown(self, monkeypatch):
        ...
        from SynapseAI.agents.memory.backends.deermem.deermem.core import prompt as prompt_module
...
class TestCountTokens:
    ...
    def test_returns_character_estimate_when_encoding_fails(self, monkeypatch):
        monkeypatch.setattr(
            "SynapseAI.agents.memory.backends.deermem.deermem.core.prompt._get_tiktoken_encoding",
    ...
    def test_returns_token_count_on_success(self, monkeypatch):
        ...
        monkeypatch.setattr("SynapseAI.agents.memory.backends.deermem.deermem.core.prompt._get_tiktoken_encoding", mock.Mock(return_value=fake_enc))
    ...
    def test_use_tiktoken_false_returns_char_estimate_without_touching_tiktoken(self, monkeypatch):
        ...
        monkeypatch.setattr("SynapseAI.agents.memory.backends.deermem.deermem.core.prompt.tiktoken.get_encoding", get_encoding_spy)
        monkeypatch.setattr("SynapseAI.agents.memory.backends.deermem.deermem.core.prompt._get_tiktoken_encoding", loader_spy)
