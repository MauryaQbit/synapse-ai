...
from SynapseAI.agents.middlewares.todo_middleware import (
    TodoMiddleware,
    _format_todos,
...
class TestWrapModelCall:
    def test_no_pending_reminder_still_injects_todo_system_prompt(self):
        """Regression for MauryaQbit/synapse-ai#4714: the base class system-prompt
...
class TestTodoMiddlewareAgentGraphIntegration:
    def test_reuses_thread_state_todos_schema_in_real_agent_graph(self):
        ...
        # Regression for MauryaQbit/synapse-ai#4714: the model request must carry
