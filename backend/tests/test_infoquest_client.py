...
from SynapseAI.community.infoquest import tools
from SynapseAI.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("SynapseAI.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("SynapseAI.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("SynapseAI.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/synapse-aiv2/synapse-ai/backend/tests/test_infoquest_client.py
