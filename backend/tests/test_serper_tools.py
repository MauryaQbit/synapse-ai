...
def reset_api_key_warned():
    ...
    import SynapseAI.community.serper.tools as serper_mod
...
def mock_config_with_key():
    with patch("SynapseAI.community.serper.tools.get_app_config") as mock:
...
class TestGetApiKey:
    def test_returns_config_key_when_present(self):
        with patch("SynapseAI.community.serper.tools.get_app_config") as mock:
            ...
            from SynapseAI.community.serper.tools import _get_api_key
...
class TestCoerceMaxResults:
    def test_returns_value_when_valid_positive_int(self):
        from SynapseAI.community.serper.tools import _coerce_max_results
...
class TestSafePublicUrl:
    def test_https_public_hostname_passes(self):
        from SynapseAI.community.serper.tools import _safe_public_url
...
class TestWebSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("SynapseAI.community.serper.tools.httpx.Client") as mock_client_cls:
            mock_client_cls.return_value.__enter__.return_value.post.return_value = mock_resp

            from SynapseAI.community.serper.tools import web_search_tool
    ...
    def test_missing_api_key_logs_warning_once(self, mock_config_no_key, caplog):
        ...
        with patch.dict("os.environ", {}, clear=True):
            ...
            with caplog.at_level(logging.WARNING, logger="SynapseAI.community.serper.tools"):
...
class TestImageSearchTool:
    def test_basic_search_returns_normalized_results(self, mock_config_with_key):
        ...
        with patch("SynapseAI.community.serper.tools.httpx.Client") as mock_client_cls:
            ...
            from SynapseAI.community.serper.tools import image_search_tool
...
def test_package_exports_image_search_tool():
    from SynapseAI.community.serper import image_search_tool
    from SynapseAI.community.serper.tools import image_search_tool as direct_image_search_tool
