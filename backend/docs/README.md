...
This directory contains detailed documentation for the SynapseAI backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs SynapseAIClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to SynapseAI?** Start with [SETUP.md](SETUP.md) for quick installation
