...
1. Start SynapseAI locally using any working development setup you already use.
   ...
   If you already have SynapseAI running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.synapse-ai/memory.json`
