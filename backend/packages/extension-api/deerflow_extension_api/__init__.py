"""Public contracts for SynapseAI extensions.

This package MUST NOT import `SynapseAI`. Every host contract an extension
...
from SynapseAI_extension_api.contracts import (
    ExtensionInstall,
    ExtensionRegistry,
...
from SynapseAI_extension_api.placement import (
    AgentBuildContext,
    AgentScope,
    MiddlewarePlacement,
    Placement,
