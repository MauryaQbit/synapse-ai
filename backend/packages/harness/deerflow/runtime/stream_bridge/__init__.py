...
# optional extra, and this package is pulled in transitively by ``SynapseAI.runtime``
...
# directly from ``SynapseAI.runtime.stream_bridge.redis`` if you need the class.
