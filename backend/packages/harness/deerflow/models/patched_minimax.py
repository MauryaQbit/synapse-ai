...
``langchain_openai.ChatOpenAI`` currently ignores that field, so SynapseAI's
...
which SynapseAI already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        SynapseAI middlewares tag user messages with internal provenance names
