...
``SYNAPSE_ALLOW_UNVERIFIED_GITHUB_WEBHOOKS=1`` to mount the route
...
_ALLOW_UNVERIFIED_ENV_VAR = "SYNAPSE_ALLOW_UNVERIFIED_GITHUB_WEBHOOKS"
...
def is_route_enabled() -> bool:
    ...
    Mounted when either:
        ...
        * ``SYNAPSE_ALLOW_UNVERIFIED_GITHUB_WEBHOOKS=1`` is set
